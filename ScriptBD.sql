...
CREATE TABLE ENQUETE(
	...
	CONSTRAINT PK_Enquete_Id PRIMARY KEY(Id),
...
CREATE TABLE OPCOES(
	...
	CONSTRAINT PK_Opcao_Id PRIMARY KEY(Id),
	CONSTRAINT Combinacao_EnqueteOpcao_Unica UNIQUE(idEnquete, Opcao),
	CONSTRAINT FK_Enquete_Id FOREIGN KEY(idEnquete) REFERENCES Enquete(id) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE COMENTAENQUETE(
	...
	CONSTRAINT FK_Aluno_Matricula FOREIGN KEY(matriculaAluno) REFERENCES ALUNO(matriculaAluno) ON DELETE RESTRICT ON UPDATE CASCADE,
	CONSTRAINT FK_Enquete_Id FOREIGN KEY(idEnquete) REFERENCES ENQUETE(id) ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE INDEX Id_Enquete ON ENQUETE(Id);
CREATE INDEX Id_Comentario ON COMENTARIOS(Id);
